...
To swap out the exes, use the following code:
```{r swap, eval = FALSE}
.libPaths() # to find where your R library is
r4ss::get_ss3_exe(dir= my_path, version = "3.30.21")
file.path("bin", folder_name, "ss3.exe" ) # Folder options are Linux64, MacOS, MacOS_arm64, Windows64
```
