...
test_that("convert_to_r4ss_names works", {
  test_sample_struct <- list(
    catch = data.frame(year = 101:106, Seas = 1, FltSvy = 1, SE = 0.01),
    CPUE = data.frame(year = c(102, 105), Seas = 7, FltSvy = 2, SE = 0.05),
    lencomp = data.frame(
      year = c(102, 105), Seas = 1, FltSvy = 1,
      Sex = 0, Part = 0, Nsamp = 125
    ),
...
test_that("create_sample_struct works", {
  ...
  expect_sample_struct <- list(
    catch = data.frame(year = 101:120, Seas = 1, FltSvy = 1, SE = 0.005),
    CPUE = data.frame(year = seq(105, 120, by = 5), Seas = 7, FltSvy = 2, SE = 0.2),
    lencomp = data.frame(year = NA, Seas = 1, FltSvy = 1, Sex = 0, Part = 0, Nsamp = 125), # because irregular input
    agecomp = data.frame(
      year = seq(105, 120, by = 5), Seas = 1, FltSvy = 2,
  ...
  expect_equivalent(
    ...
    data.frame(year = NA, Seas = 7, FltSvy = 2, SE = 0.2)
  )
})

test_that("get_full_sample_struct works", {
  spl_str <- list(
    catch = data.frame(year = 101:110),
    CPUE = data.frame(year = c(105, 110)),
    lencomp = data.frame(year = seq(102, 110, by = 2)),
    agecomp = data.frame(year = seq(102, 110, by = 4))
  )
  ...
  full_spl_str_ref <- list(
    catch = data.frame(year = 101:110, Seas = 1, FltSvy = 1, SE = 0.005),
    CPUE = data.frame(year = c(105, 110), Seas = 7, FltSvy = 2, SE = 0.2),
    lencomp = data.frame(
      year = seq(102, 110, by = 2), Seas = 1, FltSvy = 1,
      Sex = 0, Part = 0, Nsamp = 125
    ),
    agecomp = data.frame(
      year = seq(102, 110, by = 4), Seas = 1, FltSvy = 2,
      Sex = 0, Part = 0, Ageerr = 1, Lbin_lo = -1,
      Lbin_hi = -1, Nsamp = 500
    )
  )
...
test_that("get_full_sample_struct works with mean size, mean size at age", {
  ...
  spl_str <- list(
    ...
    CPUE = data.frame(year = c(105, 110), FltSvy = 2),
    lencomp = data.frame(year = seq(102, 110, by = 2), FltSvy = 1, Part = 0),
    agecomp = data.frame(year = seq(102, 110, by = 4), FltSvy = 2),
    meanbodywt = data.frame(
      year = seq(102, 110, by = 4),
      Part = 1
    ),
    MeanSize_at_Age_obs = data.frame(
      year = seq(102, 110, by = 2),
  ...
  # reference to compare against
  full_spl_str_ref <- list(
    catch = data.frame(year = 101:110, Seas = 1, FltSvy = 1, SE = 0.05),
    CPUE = data.frame(year = c(105, 110), Seas = 7, FltSvy = 2, SE = 0.3),
    lencomp = data.frame(
      year = seq(102, 110, by = 2), Seas = 7, FltSvy = 1,
      Sex = 3, Part = 0, Nsamp = 125
    ),
    agecomp = data.frame(
      year = seq(102, 110, by = 4), Seas = 7, FltSvy = 2,
      Sex = 3, Part = 0, Ageerr = 2, Lbin_lo = 1,
      Lbin_hi = -1, Nsamp = 75
    ),
    meanbodywt = data.frame(
      year = seq(102, 110, by = 4), Seas = 7, FltSvy = 1,
      Part = 1, Type = 1, Std_in = 0.3
    ),
    MeanSize_at_Age_obs = data.frame(
      year = seq(102, 110, by = 2), Seas = 7,
