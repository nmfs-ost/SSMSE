...
1 #_Forecast recruitment:  0= spawn_recr; 1=value*spawn_recr_fxn; 2=value*VirginRecr; 3=recent mean from year range above (need to set phase to -1 in control to get constant recruitment in MCMC)
