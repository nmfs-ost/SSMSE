...
2 #_report_table_selection:  0 (minimal; no wtatage.ss_new); 1 (all tables); 2 (brief), 3 (custom, read list) 
...
0 #_soft_bounds:  Use Soft Boundaries to aid convergence (0,1) (recommended)
#
...
25 #_last_estimation_phase:  turn off estimation for parameters entering after this phase
#
1 #_MCMCburn
1 #_MCMCthin
0 # jitter_fraction:  jitter within parameter bounds
1958 #_minyr_sdreport:  min year for sdreport outputs (-1 for styr); #_1958
2012 #_maxyr_sdreport:  max year for sdreport outputs (-1 for endyr+1; -2 for endyr+Nforecastyrs); #_2012
0 #_N_STD_yrs:  N individual STD years 
#COND: vector of year values if N>0

1e-07 #_converge_criterion: (e.g. 1.0e-04) 
...
-1 #_seed:  random number seed for bootstrap data (-1 to use long(time) as seed): # 1781719166
