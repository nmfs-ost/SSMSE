...
# 10 1 100 100 # selectivity; use:  10 1 100 100
# 11 1 100 100 # rel_F; use:  11 1 100 100
# 12 1 1 100 # recruitment; use:  12 1 1 100
#-9999 0 0 0
#
...
0.03 # Control rule inflection for constant F (as frac of HCR_anchor, see below); must be > control rule cutoff
