...
- base_vals:
  ...
  impact of a time varying block change
...
- temp_block:
  ...
  The time-varying parameter lines for the block effects on the base
  parameter
...
A modified parameter value series that incorporates the appropriate time
varying block effects.
